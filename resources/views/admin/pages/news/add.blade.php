                    <form method = "POST" enctype = "multipart/form-data">
						<div class = "row disable_side">
						    <div class = "col-xs-12 col-sm-12 col-md-9 col-lg-9">
								...
								<div class = "row">
								    <div class = "col-xs-12 col-sm-6 col-md-6 col-lg-6">
										<div class="form-group">
											...
											<p class="help-block">Chọn danh mục cho cho bài viết</p>
                                ...
                                <div class="form-group">
									<label>Tóm tắt</label>
									<p class="help-block">Đây là phần tóm tắt bài viết</p>
									<textarea class = "form-control summary" name = "summary" rows = "10"></textarea>
								</div>
								<div class="form-group">
								...
								<div class = "panel panel-default">
								    ...
								    <div class = "panel-footer">
								        <div class = "pull-right">
											<input type = "submit" name = "submit" class="btn btn-success" value = "Đăng bài"></button>
										</div>
										<div class = "clr"></div>
								    </div>
								</div>	
