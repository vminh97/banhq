						...
						<div class = "row disable_side">
						    <div class = "col-xs-12 col-sm-12 col-md-9 col-lg-9">
								<div class="form-group">
									...
									<input readonly type="text" class="form-control" name = "name" value = "<?php echo $info->name; ?>" placeholder="Nhập tên tài khoản">
                                    <br />
								...
								<div class="form-group">
									...
									echo $info->password; ?>" placeholder="Nhập mật khẩu">
                                    <br />
                                ...
                                <div class="form-group">
									...
									$info->email; ?>" placeholder="Nhập email">
                                    <br />
								...
								<div class="form-group">
									...
									$info->phone; ?>" placeholder="Nhập số điện thoại">
                                    <br />
